  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  className="w-full glass-input px-2.5 py-2 rounded-xl text-xs font-semibold text-sky-400"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Profile</label>
                <input
                  type="text"
                  value={newCatCustomerType}
                  onChange={(e) => setNewCatCustomerType(e.target.value)}
                  className="w-full glass-input px-2.5 py-2 rounded-xl text-xs font-semibold text-indigo-400"
                />
              </div>
            </div>
      ...
      <div className="lg:col-span-2 space-y-6">
        {categories.map((cat) => (
          <div key={cat.id} className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4 shadow-xl">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              ...
              <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-sky-400">
                ...
                >
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded bg-sky-500/10 text-sky-400 border border-sky-500/30 text-[10px] font-semibold">
                      ...
                      {item.propertyTypeScope && (
                        <span className="px-2 py-0.5 rounded bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 text-[10px] font-bold">
                          {item.propertyTypeScope}
                        </span>
                      )}
